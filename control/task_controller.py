...
class TaskController:
    ...
    def process(self):
        ...
        # 1. 只获取路径字符串，绝对不要在这里执行 os.makedirs
        ...
        try:
            ...
            if mode == "SRT2ASS":
                # 传入 final_out (通常是父目录)，由 run_ass_task 内部的 get_organized_path 创建 ass/ 文件夹
                ...
                # 以下任务内部都会调用 get_organized_path，当后缀为 .pdf/.docx/.txt 时，才会创建 script/ 文件夹
                if self.do_pdf.get():
